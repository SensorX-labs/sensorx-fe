...
export function PaymentHistoryDetailModal({
 id,
 open,
 onOpenChange,
      ...
      <div className="border border-gray-200 bg-white rounded overflow-hidden">
       ...
       <table className="w-full">
        <tbody className="divide-y divide-gray-100 text-xs">
         <tr>
          <td className="px-4 py-2.5 font-bold text-gray-500 w-1/3">
           Mã giao dịch (Sepay)
          </td>
          <td className="px-4 py-2.5 text-gray-900 font-semibold">{data.id}</td>
         </tr>
         <tr>
          <td className="px-4 py-2.5 font-bold text-gray-500">
           Cổng thanh toán
          </td>
          <td className="px-4 py-2.5 text-gray-900 font-semibold uppercase">
           {data.gateway}
          </td>
         </tr>
         <tr>
         ...
         <tr>
          ...
          <td className="px-4 py-2.5 text-gray-900 font-semibold text-blue-600 bg-blue-50/30 rounded px-1.5 py-0.5">
           {data.content}
          </td>
         </tr>
         <tr>
         ...
         <tr>
          ...
          <td className="px-4 py-2.5 text-gray-900 font-semibold">
           <span
            className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider ${data.transferType === "in" ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
           >
         ...
         <tr>
          ...
          <td className="px-4 py-2.5 text-gray-700 font-mono text-[10px]">
           {data.orderId}
          </td>
         </tr>
        </tbody>
