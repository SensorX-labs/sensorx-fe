...
// Các component con (sẽ được import sau khi tạo/cập nhật)
import { MyRfqsTab } from '../../../requestforquotation/components/store/my-rfqs-tab';
import { MyQuotationsTab } from '../../../quotation/components/store/my-quotations-tab';
import { OrdersTab } from '../../../order/components/store/orders-tab';
