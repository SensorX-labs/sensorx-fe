...
export const LoginForm: React.FC<LoginFormProps> = ({ onSwitchToRegister }) => {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    ...
    // Bắn event để Header nhận diện thay đổi ngay lập tức
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" noValidate>
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-0 py-3 bg-transparent border-b focus:outline-none text-gray-900 placeholder-gray-400 transition-colors ${errors.email
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              {...register('password')}
              placeholder="••••••••"
              className={`w-full px-0 py-3 bg-transparent border-b focus:outline-none text-gray-900 placeholder-gray-400 transition-colors pr-8 ${errors.password
                ? 'border-red-400 focus:border-red-500'
                : 'border-gray-300 focus:border-blue-500'
                }`}
            />
