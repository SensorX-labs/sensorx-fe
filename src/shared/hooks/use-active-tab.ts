...
const routeMap: Record<string, TabInfo> = {
 "/dashboard": {
  ...
  description:
   "Tổng quan hoạt động kinh doanh, số liệu và tình trạng hệ thống theo thời gian thực",
 },
 ...
 "/reports/warehouse": {
  ...
  description:
   "Quản lý hiệu suất xuất nhập kho, tỷ trọng lưu động và giá trị tồn kho",
 },
 ...
 "/sales/payment-histories": {
  title: "Lịch sử thanh toán",
  description: "Quản lý và theo dõi lịch sử giao dịch chuyển khoản",
 },
 ...
 "/catalog/internal-prices": {
  ...
  description:
   "Quản lý chính sách giá, phân tầng số lượng và chiết khấu cho đối tác",
 },
};
